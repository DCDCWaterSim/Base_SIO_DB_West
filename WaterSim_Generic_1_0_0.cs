...
//         CRF_Network_WaterSim_America UnitNetwork;
        //
        RateDataClass FRDC = null;
        ...
        //
        /// <summary>
        ///  Constructor for WaterSimCRFModel
        /// </summary>
        #region Constructor
        ...
        public WaterSimCRFModel(string DataDirectoryName, string TempDirectoryName)
        {
            ...
            try
            {
                ...
                string StateDataPath = DataDirectoryName + "//" + StateData;
                FUnitData = new UnitData(StateDataPath);
                UnitNetwork = new CRF_Unit_Network(FUnitData, State);

//                UnitNetwork = new CRF_Unit_Network(DataDirectoryName + "\\" + StateData, null, State);
        ...
        public WaterSimCRFModel(UnitData TheUnitData, RateDataClass TheRateData, string TheUnitName)
        {
            ...
            UnitNetwork = new CRF_Unit_Network(TheUnitData, State);
        ...
        {
            get { return FRDC.INDRate(FStateIndex); }
            set { FIndRate = value; }
        ...
        {
            get { return FRDC.POPRate(FStateIndex); }
            set { FPopRate = value; }
        }
        ...
        public int geti_SurfaceWaterSaline()
        {
            ...
            //return result;
            //int TempInt = Convert.ToInt32(Math.Round(UnitNetwork.SurfaceSaline.Limit));
            return result;
        }
        ...
        public void seti_Effluent(int value)
        {
            ...
            if (invokePolicies)
            {
                ...
                UnitNetwork.Effluent.Limit = Math.Min(maxReclaimed, (double)value + effluentToAdd);
        ...
        ///-----------------------------------------------------------------
        protected double d_popGrowthRate = 1.00;
