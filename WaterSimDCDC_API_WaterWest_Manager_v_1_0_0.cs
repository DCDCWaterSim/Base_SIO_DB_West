...
namespace WaterSimDCDC
{
    ...
    public enum eProvider
    {
        eArizonaRiver, eArizonaCentral, eArizonaOther, eCaliforniaUrban, eCaliforniaAg, eColoradoWesternSlope, eColoradoUrban, eColoradoFrontRangeAg, eNevadaUrban, eNewMexicoUrban, eUtahUrban, eUtahOther, eWyoming, 
          eBasin
    }
    ...
    public static partial class ProviderClass
    {
        ...
        /// </summary>
        /// <value>eProvider enum</value>
        public const eProvider FirstProvider = eProvider.eArizonaRiver;
        ...
        private static string[] ProviderNameList = new string[TotalNumberOfProviderEnums]    {      
          ...
          "ArizonaRiver", "ArizonaCentral", "ArizonaOther", "CaliforniaUrban", "CaliforniaAg", "ColoradoWesternSlope", "ColoradoUrban", "ColoradoFrontRangeAg", 
          "NevadaUrban", "NewMexicoUrban", "UtahUrban", "UtahOther", "Wyoming", "Colorado Basin"
             };

        private static string[] FieldNameList = new string[TotalNumberOfProviderEnums]  {      
 
            "AZR", "AZC", "AZO", "CAU",  "CAA", "COW",  "COU", "COF", "NVU", "NMU", "UTU", "UTO","WYU","CB"
            ,
           };
        ...
        //};
        private static eProvider[] BasinProviders = new eProvider[13] {
            eProvider.eArizonaRiver, eProvider.eArizonaCentral, eProvider.eArizonaOther, eProvider.eCaliforniaUrban, eProvider.eCaliforniaAg, eProvider.eColoradoWesternSlope,
            eProvider.eColoradoUrban,eProvider.eColoradoFrontRangeAg,eProvider.eNevadaUrban,eProvider.eNewMexicoUrban,eProvider.eUtahUrban,eProvider.eUtahOther,
            eProvider.eWyoming
        };
