...
//        RateDataClass RDC;
        ...
        //    get { return WSA; }
        //}
//        public  CRF_Unit_Network  CRF_Network_WaterSim_America TheCRFNetwork
...
//            get { return WSA; }
        ...
        {
            FAgRate = FRDC.FastAGRate(FStateIndex);
            FIndRate = FRDC.FastINDRate(FStateIndex);
            FPopRate = FRDC.FastPopRate(FStateIndex);
        }

        void SetInitialDemandFactors()
        {
            FAgNet = FRDC.FastAgNet(FStateIndex);
