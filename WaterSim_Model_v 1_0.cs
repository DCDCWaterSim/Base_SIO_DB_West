...
#region MODEL ERRORS
    ...
    public class WaterSimModel
    {
        ...
        {
            string UnitDataFielname = "Just15StatesLakeNoRuralPower.csv"; //string UnitDataFielname = "Just11StatesLakeNoRuralPower.csv";// "Just5StatesLakeNoRural.csv"; //"Just5StatesLake.csv";// "JustSmithStates.csv";// "All_50_states.csv";
          //  string RateDataFilename = "ElevenStateGrowthRates3.csv"; //"ElevenStateGrowthRates.csv";
          //  string UnitDataFielname = "BasinStatesSubRegionData.csv";
            string RateDataFilename = "FifteenStateGrowthRates3.csv";
           // string FFilename = "FifteenStateGrowthRates3.csv";
            try
            {
                //StreamW(DataDirectoryName);
                FUnitData = new UnitData(DataDirectoryName + "//" + UnitDataFielname);
...
#region ProviderProperties
        ...
        //  PopGrowthAdjustment
        //=======================================================
        #region PopGrowthAdjustment
        ///------------------------------------------------------
        /// <summary> The PopGrowthAdjustment provider property  </summary>
        ///------------------------------------------------------
        public providerArrayProperty PopGrowthAdjustment;

        ///------------------------------------------------------
        /// <summary> Gets the PopGrowthAdjustment  </summary>
        ///<returns> the PopGrowthAdjustment </returns>
