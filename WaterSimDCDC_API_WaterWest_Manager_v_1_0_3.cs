...
namespace WaterSimDCDC
{
    ...
    public enum eProvider
    {
        ...
        eAZ_Other, eAZ_Central, eAZ_West, eCA_Urban, eCA_Other, eCA_Imperial, eCA_Basin, eCO_Other, eCO_FrontRange, eCO_Basin, eNV_Other, eNV_LasVegas,eNV_Basin,
        eNM_Other, eNM_Urban, eNM_Basin, eUT_Other, eUT_Urban, eUT_Basin, eWY_Urban, eWY_Basin,eWY_Other, eBasin
    }
    ...
    public static partial class ProviderClass
    {
        ...
        public const eProvider LastProvider = eProvider.eWY_Other;

        /// <summary>
        /// The first valid enum value
        /// </summary>
        /// <value>eProvider enum</value>
        public const eProvider FirstProvider = eProvider.eAZ_Other;
        ...
        private static string[] ProviderNameList = new string[TotalNumberOfProviderEnums]    {      
         ...
         //"Arizona", "California", "Colorado", "Florida",  "Idaho", "Illinois",  "Minnesota", "Nevada", "NewMexico", "Utah", "Wyoming", "Colorado Basin"
          "AZ_Other", "AZ_Central", "AZ_West", "CA_Urban", "CA_Other", "CA_Imperial", "CA_Basin", "CO_Other", "CO_FrontRange", "CO_Basin", 
          "NV_Other", "NV_LasVegas","NV_Basin", "NM_Other", "NM_Urban", "NM_Basin", "UT_Other", "UT_Urban",  "UT_Basin","WY_Urban","WY_Basin", "WY_Other", "Colorado Basin"
        ...
        private static string[] FieldNameList = new string[TotalNumberOfProviderEnums]  {      
            ...
            //"AZ","CA","CO","FL","ID","IL","MN","NV","NM","UT","WY","CB"
             "AZO", "AZC", "AZW", "CAU","CAO", "CAI", "CAB", "COO", "COF", "COB", "NVO", "NVL", "NVB", "NMO", "NMU", "NMB","UTO", "UTU", "UTB", "WYU", "WYB", "WYO", "CB"
           };

        private static eProvider[] BasinProviders = new eProvider[22] {
            //eProvider.eArizona, eProvider.eCalifornia, eProvider.eColorado, eProvider.eNevada, eProvider.eNewMexico, eProvider.eUtah, eProvider.eWyoming
              eProvider.eAZ_Other, eProvider.eAZ_Central, eProvider.eAZ_West, 
              eProvider.eCA_Urban, eProvider.eCA_Other, eProvider.eCA_Imperial, eProvider.eCA_Basin, 
              eProvider.eCO_Other, eProvider.eCO_FrontRange, eProvider.eCO_Basin, 
              eProvider.eNV_Other, eProvider.eNV_LasVegas,eProvider.eNV_Basin,
              eProvider.eNM_Other, eProvider.eNM_Urban, eProvider.eNM_Basin, 
              eProvider.eUT_Other, eProvider.eUT_Urban, eProvider.eUT_Basin, 
              eProvider.eWY_Urban, eProvider.eWY_Basin, eProvider.eWY_Other
...
//        protected WaterSimAmerica WSmith=null;
      ...
      //  WaterSimDCDC.Processes.AlterWaterManagementFeedbackProcess WM;
        ...
        // 10.10.17 das
        //
        protected void initialize_FeedbackProcesses(WaterSimManager WSM)
        {
            string name = "Alter Parameters from Tree Nodes";
            bool Quiet = true;
            WaterSimDCDC.Processes.ModifyPoliciesFeedbackProcess MPF = new Processes.ModifyPoliciesFeedbackProcess(name, WSM, Quiet);
            this.ProcessManager.AddProcess(MPF);
        ...
        protected override void initialize_ModelParameters()
        {
            ...
            // 10.10.17 das
            initialize_FeedbackProcesses(WSim);
            //
          //  WSim.ProcessManager.AddProcess(WM);
            ...
            // QUAY EDIT 8 16 17 
            // Changed REC_P toRECN_P,
            // See epP_ReclainedWaterUse, fpr existing REC_P
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_SurfaceLake, "Surface Lake Water", "SUL_P", WestModel.SurfaceLake));
            ...
            // QUAY EDIT 8 16 17 
            // Changed P_P to PE_P,
            // See epP_POwer fpr existing P_P
            ...
            // UrbanWaterConservation - Updated by Quay/sampson
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_UrbanWaterConservation, "Water Conservation (urban & rural)", "UCO_P",
            rangeChecktype.rctCheckRange, 50, 100, null, WestModel.UrbanWaterConservation));
            ...
            // AgWaterConservation  - Updated by sampson (03.16.17)
            // Input Parameter
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_AgWaterConservation, "Ag Water Conservation", "ACO_P",
            rangeChecktype.rctCheckRange, 50, 100, null, WestModel.AgWaterConservation));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_PowerWaterConservation, "Power Water Conservation", "PCO_P", rangeChecktype.rctCheckRange, 50, 100, null, WestModel.PowerWaterConservation));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_IndustrialWaterConservation, "Industrial Water Conservation", "ICO_P", rangeChecktype.rctCheckRange, 50, 100, null, WestModel.IndustrialWaterConservation));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_SurfaceWaterManagement, "Modify Surface Water Use", "SW_P",
                rangeChecktype.rctCheckRange, 80, 150, null, WestModel.SurfaceWaterManagement));
           // _pm.AddParameter(new ModelParameterClass(eModelParam.epP_SurfaceWaterManagement, "Modify Surface Water", "SW_P", WestModel.SurfaceWaterManagement));
            ...
            // QUAY EDIT 8 16 17 
            // Changed GW_P to GWM_P
            // See epP_GroundwaterNet for exist GW_P
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_GroundwaterManagement, "Modify Groundwater Use", "GWM_P",
            rangeChecktype.rctCheckRange, 80, 150, null, WestModel.GroundwaterManagement));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_ReclainedWaterUse, "Use Reclaimed Water", "REC_P",
                 rangeChecktype.rctCheckRange, 0, 100, null, WestModel.ReclainedWaterUse));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_LakeWaterManagement, "Increase Lake Water use", "LW_P", rangeChecktype.rctCheckRange, 50, 125, RangeCheck.NoSpecialProvider, WestModel.LakeWaterManagement));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_Augmented, "Augmented Desal", "DESA_P", rangeChecktype.rctCheckRange, 50, 125, RangeCheck.NoSpecialProvider, WestModel.Augmented));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_PopGrowthRates, "Population Growth Projected", "POPG_P", WestModel.PopGrowthRate));
            ExtendDoc.Add(new WaterSimDescripItem(eModelParam.epP_PopGrowthRates, "Adjustment in the Projected Population Growth Rate.", "%", "Population Growth", "", new string[4] { "Low", "Some", "Planned", "High" }, new int[4] { 60, 80, 100, 120 }, new ModelParameterGroupClass[] { }));
            //
            // 08.07.17 das
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_PopGrowthRateModifyer, "Modified Population Growth Projected", "POPGRM_P", rangeChecktype.rctCheckRange, 0, 150, RangeCheck.NoSpecialProvider,WestModel.PopGrowthRateModifyer));
            ExtendDoc.Add(new WaterSimDescripItem(eModelParam.epP_PopGrowthRateModifyer, "Increase or decrease the Projected Population Growth Rate.", "%", "Delta Population Growth", "", new string[4] { "Low", "Some", "Planned", "High" }, new int[4] { 60, 80, 100, 120 }, new ModelParameterGroupClass[] { }));
            ...
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_ClimateDrought, "Modify Drought Impacts", "CLI_P", rangeChecktype.rctCheckRange, 50, 150, RangeCheck.NoSpecialProvider, WestModel.ClimateDrought));
           ...
           // _pm.AddParameter(new ModelParameterClass(eModelParam.epP_DroughtControl, "Drought Impacts Control- controls rate", "D_P", WestModel.DroughtControl));
            _pm.AddParameter(new ModelParameterClass(eModelParam.epP_DroughtControl, "Drought Impacts Control- controls rate", "D_P", rangeChecktype.rctCheckRange, 50, 150, RangeCheck.NoSpecialProvider, WestModel.DroughtControl));
            ...
            // QUAY EDIT 8 16 17 
            // Changed SUR_P_P to SURL_P_P
            // See epP_SUR_PD for existing SUR_P_P, 
